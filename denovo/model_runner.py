...
def predict(
    ...
    """
    Predict peptide sequences with a trained PhysNovo model.
...
def evaluate(
    ...
    """
    Evaluate peptide sequence predictions from a trained PhysNovo model.
...
def _execute_existing(
    ...
    """
    Predict peptide sequences with a trained PhysNovo model with/without
    evaluation.
